...
| `src/services/jobs/` | Job product workflows, execution lifecycle, queue coordination, and viewer/job read-model projection | `jobs.ts`, `types.ts`, `runtime/`, `projections/`, `index.ts` |
