...
| `src/platform/` | Local machine integration for install, self-update, scheduler automation, diagnostics probes, local transcript discovery, and external source mechanics | `install/`, `update/`, `automation/`, `diagnostics/`, `transcripts/`, `github/` |
