...
| `src/services/setup/` | Setup product workflows over agent readiness/config state while CLI setup files own terminal UI | `agent-choice.ts`, `auto-commit.ts`, `index.ts` |
