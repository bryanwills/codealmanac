...
Sent: 2026-07-02 after Slice 9 verification.
...
| --- | ---: | ---: | --- |
| CodeAlmanac backend/local | 47% | 42% | Slice 9 added local run preparation from claimed trigger to worker workspace, engine request artifact, and control run refs. |
