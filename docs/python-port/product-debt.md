...
| Setup terminal UX | partially resolved: slice 79 restores setup/uninstall-owned Codex and Claude instruction artifacts. Still missing: branded raw-mode TUI, target selection UI, default agent/model selection, local automation choices, and polished next-step box. |
