...
Auto-commit is prompt policy, not a CodeAlmanac staging engine [@agreement]. Lifecycle agents may be instructed to use Git, but CodeAlmanac itself should not classify changes, stage files intelligently, or decide commit boundaries.
